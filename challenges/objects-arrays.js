...
const unisWithUni = [];
  graduates.forEach(graduates => {
    if (graduates.university.match("Uni")){
      unisWithUni.push(graduates) // since I want them to come back as objects, I just did graduates alone so each object in the array would come back. However if I just wanted the new array to contain the university names with Uni in the name, i would do unisWithUni.push(graduates.university).
    }
  })
